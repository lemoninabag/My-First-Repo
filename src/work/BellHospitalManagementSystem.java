...
public class BellHospitalManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        // Print the hospital name and separator
        System.out.println("");
        System.out.println("\033[0;1m" + "BELL HOSPITAL ManagementSystem" + "\033[0m");
        System.out.println("----------------------------------------------------------------");
        ...
        menu apps = new menu();
        // Set menu options
        menu.setHead1("1. Doctor");
        menu.setHead2("2. Patient");
        menu.setHead3("3. Medicine");
        menu.setHead4("4. Appointment");
        
        octor[] d = new doctor[10];
        ...
        while (status == 1) {
            ...
            System.out.println("---------------------------------------------------------------------");
            System.out.println(menu.getHead1() + "  " + menu.getHead3() + "  " + menu.getHead4());
            System.out.println("----------------------------------------------------------------------");
            System.out.println("For Doctor");
            System.out.println("----------------------------------------------------------------------");
            System.out.println(menu.getHead2());
            ...
            switch (choice) {
                ...
                case 2:
                    // Implement Patient functionality
                {
                    System.out.println("----------------------------------------------------------------------------------------");
                ...
                case 3:
                    // Implement Medicine functionality
                {
                    s3 = 1;
                    System.out.println("----------------------------------------------------------------------------------------");
